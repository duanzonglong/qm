...
public class ReceiverInfo {
    ...
    protected String id;
    @XmlElement(required = true)
    protected String contactorPerson;

    public String getContactorPerson()
    {
        return contactorPerson;
    }

    public void setContactorPerson(String contactorPerson)
    {
        this.contactorPerson = contactorPerson;
    }
